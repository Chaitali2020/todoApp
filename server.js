...
async function go(){
  let client = new MongoClient('mongodb+srv://todoAppUser:todoApp@jsfullstack.ods99ja.mongodb.net/TodoApp?retryWrites=true&w=majority')
...
function passwordProtected(req,res,next){
  console.log("our custom fun just ram!")
